...
const wallaceGreen = new THREE.MeshStandardMaterial({ color: 0x1e3b2a, roughness: 0.45, metalness: 0.4 });
const waterMat = new THREE.MeshStandardMaterial({ color: 0x2b4a52, roughness: 0.15, metalness: 0.1 });
